...
export const navItems = [
  ...
  { label: "Virtual Cards", to: "/cards", icon: Card },
  { label: "Buy & Sell Giftcard", to: "/giftcard", icon: BitcoinRefresh },
  { label: "Airtime Purchase", to: "/airtime", icon: Mobile },
  { label: "Data Purchase", to: "/data", icon: Wifi },
  { label: "SMM Services", to: "/smm", icon: TrendUp },
  { label: "Social Accounts", to: "/accounts", icon: ShoppingCart },
  { label: "Numbers & eSIM", to: "/numbers", icon: CallCalling },
...
export const categoriesServices: ServiceCategory[] = [
  {
    ...
    color: "text-emerald-600 bg-emerald-500/10 ring-1 ring-emerald-500/20",
    items: servicesByLinks(["/data", "/airtime"]),
  },
  {
    id: "social",
    title: "Social & growth",
    description: "Boost reach and buy verified accounts",
    color: "text-fuchsia-600 bg-fuchsia-500/10 ring-1 ring-fuchsia-500/20 dark:text-fuchsia-400",
    items: servicesByLinks(["/smm", "/accounts"]),
  },
  {
    id: "numbers-sim",
    title: "Numbers & eSIM",
    description: "Virtual numbers and eSIM for verification",
    color: "text-cyan-600 bg-cyan-500/10 ring-1 ring-cyan-500/20 dark:text-cyan-400",
    items: servicesByLinks(["/numbers"]),
  },
  {
    id: "cards-giftcards",
    title: "Cards & giftcards",
    description: "Virtual cards and giftcard payouts",
    color: "text-violet-600 bg-violet-500/10 ring-1 ring-violet-500/20 dark:text-violet-400",
    items: servicesByLinks(["/cards", "/giftcard"]),
  },
];
